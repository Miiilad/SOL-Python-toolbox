...
chosen_bases=['1','x','xx']
measure_dim=n
Lib=SOL.Library(chosen_bases,measure_dim,m)
p=Lib._Phi_dim
Theta_dim=(m+1)*p
print('Set of Bases:',Lib._Phi_lbl)
#Building a Database
db_dim=1000
Database=SOL.Database(db_dim=db_dim,Theta_dim=Theta_dim,output_dir_path=output_dir_path,Lib=Lib,load=True,save=True)
...
#Simulation results
Sim=SOL.SimResults(t,Lib,Database,SysID,Controller,select=select_output_graphs,output_dir_path=output_dir_path)
